# Media asset checklist — Red Mangrove — The Walking Tree

Masters are committed under `media/assets/` (**under 2 MB each**).
Sync into Xibo Library folder `exhibits/red-mangrove`.
...
| --- | --- | --- |
| `graphic-mangrove-id` | `graphic-mangrove-id.png` | Present — transparent PNG in lower hero frame |
| `bg-hero-mangrove` | `bg-hero-mangrove.jpg` | Present — **800×1080** portrait wash (fills pane; no letterbox) |
...
| `graphic-roots-stilts` | `graphic-roots-stilts.png` | Present — transparent card art |
| `graphic-nursery-roots` | `graphic-nursery-roots.png` | Present — transparent card art |
| `graphic-fact-propagules` | `graphic-fact-propagules.png` | Present — transparent card art |
