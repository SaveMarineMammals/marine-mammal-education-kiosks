# Layout recipe: Red Mangrove — The Walking Tree
...
| `hero-bg` | A | 800×1080 @ 0,0 | 1 | Portrait mangrove wash (fills pane — no letterbox) |
| `hero-still` | A | 720×740 @ 40,300 | 2 | Transparent mangrove ID in lower frame |
...
Build in Xibo CMS using Library media tagged `exhibit:red-mangrove`.

## Insight card overview

| Card | Window | Title | Art asset |
| --- | --- | --- | --- |
| 1 | 0–6s | Stilt Roots | `graphic-roots-stilts` |
| 2 | 6–12s | Fish Nursery | `graphic-nursery-roots` |
| 3 | 12–18s | Hidden Fact | `graphic-fact-propagules` |
